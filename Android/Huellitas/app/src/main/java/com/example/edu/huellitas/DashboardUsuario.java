...
public class DashboardUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pie.title("Cantidad de usuarios registrados según su tipo");
    ...
    public void ConsumirWS(){
        ...
        String url = con.ConecBase() + con.DashboardUsuario();
            ...
            public void onResponse(JSONArray response) {
                try {
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        data.add(new ValueDataEntry(dbu.getString("rol"), Integer.parseInt(dbu.getString("cantidad"))));
                    }
                    pie.data(data);
